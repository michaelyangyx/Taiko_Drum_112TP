...
INST1="This is a Pokemon Drum Game developed by Michael Yang!"
INST2="Press Start Game in main menu to start game."
INST3="The beats you hit drum are generated by the amplitude of the music file."
INST4="You can choose your own music file to play."
INST5="In the game:"
INST6="When a drum comes to the grey drum, hit it."
INST7="Press 'K' to hit the Wobbuffet (blue) drum."
INST8="Press 'D' to hit the Charmander (orange) drum."
INST9="Press Space to hit the Jigglypuff (pink) drum."
INST10="These three drums are created according to different amplitude levels."
INST11="The state on the left shows how well you've hitten the beat."
INST12="The score will go up according to the state you hit the drum."
INST13="If you hit drums without mis-pressing the button, combo will go up."
INST14="Have fun! Press Main Menu to go back."
    ...
    def run(self):
        ...
        while self.mainloop:
            ...
            if pygame.mouse.get_rel()!=(0,0): #mouse movement
                self.mouse_mode=True
                self.keyboard_item=None
            background_image_filename=os.path.join('pics','insbg.png')
